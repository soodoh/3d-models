...
- `gridfinity_box`: Gridfinity storage box with a stacking lip or an opt-in matching
  ...
  `lid_text`, scoops, decimal-unit dividers, raised floors, and automatic Gridfinity-boundary
  ...
  footprint axis. Raised lid text runs along the fixed-width rail opposite the opening.
